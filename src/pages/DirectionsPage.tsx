      ...
      <div className="bg-white">
        ...
        <div className="mt-4">
          ...
          <div className="flex mt-2">
            ...
            <a href="nmap://search?query=%EB%84%A4%EC%9D%B4%EB%B2%841784" target="_blank" rel="noopener noreferrer" className="mx-1 bg-green-500 text-white px-4 py-2 rounded">Naver Maps</a>
          </div>
        </div>
      </div>
    </Card>
